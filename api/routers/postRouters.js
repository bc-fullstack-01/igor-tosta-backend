...
router
    ...
    .post((req, res, next) => Promise.resolve()
        .then(() => Post.findByIdAndUpdate({ _id: req.params.id }, { $addToSet: {likes: req.user.profile._id } }))
...
router
    ...
    .post((req, res, next) => Promise.resolve()
        .then(() => Post.findByIdAndUpdate({ _id: req.params.id }, { $pull: {likes: req.user.profile._id } }))
